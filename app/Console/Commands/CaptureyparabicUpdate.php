...
class CaptureyparabicUpdate extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'yp:arabicUpdate';
     ...
     * @var string
     */
    protected $description = 'update existing arabic yellowpages Database';
    ...
    function get_companys_in_cat($cat){
        ...
        if(DB::table('yellowpagesarabic')->where('search_id', $company_id)->exists()){continue;}
        echo "\n"."new company found ".$company_title." in category ".$cat."\n";
$text2append="\n"."new company found ".$company_title." in category ".$cat."\n";
        Storage::append('arabicYP.log', $text2append);
